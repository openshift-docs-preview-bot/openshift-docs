...
[NOTE]
====
If you are installing {ProductName} on a xref:../../installing/understanding-installations.html#installation-methods-for-different-platforms_understanding-installations[restricted network], follow the instructions for your chosen {product-title} infrastructure.
====
+
