...
[IMPORTANT]
====
The `install-config.yaml` file is transformed into the Kubernetes manifests during the installation process, and the original file is deleted. If you want to reuse the file, you must back it up now.
====
