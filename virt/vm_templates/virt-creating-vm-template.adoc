...
include::modules/virt-understanding-vm-templates.adoc[leveloffset=+1]
...
*Storage*, and *Advanced* panes in the *Create Virtual Machine Template* interactive wizard.

:vmtemplate:
include::modules/virt-vm-template-wizard-fields-web.adoc[leveloffset=+2]
