...
[NOTE]
====
{product-title} 4.7 supports Operator SDK v1.4.0.
====
...
* xref:../../operators/operator_sdk/golang/osdk-golang-tutorial.html#osdk-bundling-deploying-using-olm_osdk-golang-tutorial[Bundling and deploying your Operator using OLM]
