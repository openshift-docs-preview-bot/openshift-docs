...
You can replace public IPv4 addresses with addresses in the TEST-NET-3 address block reserved for documentation, which ranges from 203.0.113.0 to 203.0.113.255.  
