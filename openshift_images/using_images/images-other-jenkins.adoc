...
The image is based on the link:https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux_atomic_host/7/html-single getting_started_with_containers index#using_red_hat_base_container_images_standard_and_minimal[Red Hat Universal Base Images] (UBI).
...
The {product-title} Jenkins images are available on link:quay.io[Quay.io] or
