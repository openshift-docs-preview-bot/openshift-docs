...
* You downloaded the playbooks in "Downloading the removal playbooks."
* You modified the playbooks that you downloaded to reflect any changes that you made to the installation playbooks.
