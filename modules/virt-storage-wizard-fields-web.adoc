...
The following advanced storage settings are available for *Blank*, *Import via URL*, and *Clone existing PVC* disks.
The following advanced storage settings are available for *
