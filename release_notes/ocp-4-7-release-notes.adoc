...
You can now enable QEMU Guest Agent support by setting the `platform.openstack.clusterOSImage` property in the `install-config.yaml` file during installation.
