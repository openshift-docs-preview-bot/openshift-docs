[id="understanding-installations"]
= Understanding installations
include::modules/common-attributes.adoc[]
:context: understanding-installations
toc::[]
...
[id="installation-methods-for-different-platforms_{context}"]
...
[id="understanding-installations-next-steps"]
== Next steps
